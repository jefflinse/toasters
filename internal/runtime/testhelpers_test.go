...
func (s *noopStore) ListSessionsForJob(_ context.Context, _ string) ([]*db.WorkerSession, error) {
	return nil, nil
}
...
func (s *noopStore) MarkSessionMessagesSuperseded(_ context.Context, _ string, _ int) error {
	return nil
}
